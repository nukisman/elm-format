...
type alias TypeWithArgs a b c = List ( a, b, { field : c } )

type alias TypeWithArgs2 a b c =
  List
    ( a
    , b
    , { field : c
...
type alias MoreTypes x y z = { x | field : y, rec : { z : z }, fn : y -> String -> x }

type alias MoreTypes2 x y z =
  { x
  | field : y
  , rec : { z : z }
  , fn : y -> String -> x
...
port runner = Signal.constant (Task.succeed ())
